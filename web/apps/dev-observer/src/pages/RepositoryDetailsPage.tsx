...
import {GitHubChangeSummaries} from "@/components/repos/GitHubChangeSummaries.tsx";
      ...
      {loading ? (
        ...
        <div>
          ...
          <div className="space-y-8">
            ...
            <GitHubChangeSummaries repoId={repository.id} repoName={repository.name || repository.fullName} />
          </div>
        </div>
      ) : (
