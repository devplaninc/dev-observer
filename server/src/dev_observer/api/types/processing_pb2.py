...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PROCESSINGITEMKEY']._serialized_end=166
  _globals['_PROCESSINGITEM']._serialized_start=169
  _globals['_PROCESSINGITEM']._serialized_end=469
