...
class GitHubRepository(_message.Message):
    __slots__ = ("id", "name", "full_name", "url", "description", "properties", "change_analysis_enrolled")
    ...
    CHANGE_ANALYSIS_ENROLLED_FIELD_NUMBER: _ClassVar[int]
    id: str
    name: str
    full_name: str
    url: str
    ...
    change_analysis_enrolled: bool
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., full_name: _Optional[str] = ..., url: _Optional[str] = ..., description: _Optional[str] = ..., properties: _Optional[_Union[GitProperties, _Mapping]] = ..., change_analysis_enrolled: bool = ...) -> None: ...
